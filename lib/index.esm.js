...
const CustomTextField = ({ label = 'Field label', value = 'Hello there', onChangeHandler, }) => {
    return (jsxRuntimeExports.jsx(StyledTextField, { value: value, onChange: onChangeHandler, label: label }));
};
...
const CustomButton = ({ buttonText = 'Hi there', onClickHandler = () => { }, }) => {
    return jsxRuntimeExports.jsx(StyledButton, { onClick: onClickHandler, children: buttonText });
};
